...
import { assetComposition, CompositionSlice } from '../../utils/balanceSheetData';
...
const AssetCompositionCard = ({ centerValue, slices }: AssetCompositionCardProps) => (
    <SectionCard title={assetComposition.title} subtitle={assetComposition.subtitle}>
        <div className="relative h-[200px] w-full">
            ...
            >
                <Text className="text-xs text-slate-400">{assetComposition.centerLabel}</Text>
...
export default AssetCompositionCard;
