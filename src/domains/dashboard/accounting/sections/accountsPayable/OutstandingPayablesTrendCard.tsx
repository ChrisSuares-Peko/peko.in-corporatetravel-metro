...
interface OutstandingPayablesTrendCardProps {
    trend: TrendPoint[];
}

const OutstandingPayablesTrendCard = ({ trend }: OutstandingPayablesTrendCardProps) => (
    <SectionCard title={outstandingPayablesTrendTitle}>
        <div className="h-[260px] w-full">
            <ResponsiveContainer width="100%" height={260}>
                <AreaChart data={trend}>
                    <defs>
                        <linearGradient id="apTrendGradient" x1={0} y1={0} x2={0} y2={1}>
...
export default OutstandingPayablesTrendCard;
