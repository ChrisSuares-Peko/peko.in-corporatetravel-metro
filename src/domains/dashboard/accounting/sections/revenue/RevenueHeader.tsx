...
import { revenueStatementHeader } from '../../utils/revenueStatementData';
        ...
        <Flex gap={16} className="w-full flex-col xl:flex-row xl:items-start xl:justify-between">
            ...
            <Flex gap={12} className="flex-wrap items-center">
                ...
                <Select
                    ...
                    className="h-12 w-full sm:w-auto sm:min-w-[12rem] [&_.ant-select-selector]:!h-12 [&_.ant-select-selector]:!items-center [&_.ant-select-selector]:!rounded-lg [&_.ant-select-selector]:!border-borderStrong"
                />
                ...
                >
                    {revenueStatementHeader.exportLabel}
                </Button>
            </Flex>
        </Flex>
    );
