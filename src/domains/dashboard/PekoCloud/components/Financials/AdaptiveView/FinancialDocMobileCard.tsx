...
import { RightOutlined, EditOutlined, DeleteOutlined, DownloadOutlined } from '@ant-design/icons';
...
const FinancialDocMobileCard: React.FC<HistoryCardProps> = ({
    item,
    handleDelete,
    handleEdit,
    handleDocDownload,
    ...
    const details = [
        ...
        { label: 'Issued Date', value: formatDate(item.issueDate) },
            ...
            <Flex gap={20} vertical>
                ...
                {showMore && (
                    <Flex vertical gap={10} className="p-6 bg-bgLightGray">
                        ...
                        <Flex justify="center">
                            {item.documentNumber && item.issueDate ? (
                                <Space size="middle">
                                    {/* <a
                                        href={item.document}
                                        target="_blank"
...
export default FinancialDocMobileCard;
