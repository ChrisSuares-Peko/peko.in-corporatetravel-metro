...
const ChequeManagementMobileCard: React.FC<HistoryCardProps> = ({
    item,
    handleDelete,
    handleEdit,
    handleDocDownload,
    ...
    const details = [
        ...
        { label: 'Cheque Date', value: formatDate(item?.dateOfCheque) },
...
export default ChequeManagementMobileCard;
