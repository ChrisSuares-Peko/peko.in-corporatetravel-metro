...
const EmptyDocsMessage = React.memo(() => (
    <Flex className="w-full h-96" justify="center" align="center" gap={20} vertical>
        <ReactSVG src={emptyDocsSVG} />
        <Text className="text-center text-gray-400 ms-2 text-base">No files found</Text>
    </Flex>
));
...
function BDocsCategory() {
    ...
    return (
        <Content className="mb-20">
            <Text className="font-medium text-lg sm:text-xl">Business Docs</Text>
