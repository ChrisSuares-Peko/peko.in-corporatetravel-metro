...
import { ENACHMandateFormValues } from '../../../types/CollectPayment';
...
const ENACHMandateModal = ({ open, onCancel, onSuccess, documentData }: ENACHMandateModalProps) => {
                ...
                {step === 2 && (
                    <MandateForm
                        initialValues={{
                            ...
                            mobile: documentData?.customerPhone,
                        }}
                        onBack={() => setStep(1)}
