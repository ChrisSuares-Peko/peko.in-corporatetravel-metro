...
import { VirtualAccountDetails } from '../../types/CollectPayment';
        ...
        >
            <Flex vertical gap={16} className="p-7">
                ...
                <InfoItem
                    ...
                    description={`This virtual account is dedicated for receiving payment for document ${data.documentNo}. Funds received will be automatically reconciled.`}
                ...
                <Flex className="px-4 py-3 bg-amber-50 rounded-xl border border-amber-200" gap={8}>
                    <Typography.Text className="text-[#475569] text-xs">
                        ...
                        Please ensure your customer includes the document number ({data.documentNo})
