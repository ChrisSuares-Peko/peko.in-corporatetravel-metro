...
type SalaryCompHeaderProps = {
    onAddComponent: () => void;
    amount?: number | string;
    tableLoading: boolean;
};

const SalaryCompHeader = ({ onAddComponent, amount, tableLoading }: SalaryCompHeaderProps) => {
    ...
    return tableLoading ? (
        ...
        <Row gutter={[12, 15]}>
            <Col span={21}>
                ...
                >
                    <BoldText
                        text={`Total Earnings: ₹ ${formatNumberWithLocalString(
                            safeAmount
...
export default SalaryCompHeader;
