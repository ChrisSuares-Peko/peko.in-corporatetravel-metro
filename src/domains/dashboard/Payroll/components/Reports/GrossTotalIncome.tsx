...
const GrossTotalIncome: React.FC<Props> = ({ onChange, fieldName = 'grossTotalIncome' }: any) => {
    ...
    const [data] = useState([
        { key: '1', Component: 'Salaries', amountPaid: 'salaries' },
        { key: '2', Component: 'Other Incomes', amountPaid: 'otherIncomes' },
    ...
    useEffect(() => {
        setFieldValue(fieldName, {
            salaries: data[0]?.amountPaid || '',
            otherIncomes: data[1]?.amountPaid || '',
            total,
        });
