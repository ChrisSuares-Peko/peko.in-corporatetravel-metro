...
describe('PlanCardMobile Component', () => {
    ...
    it('calculates and displays yearly cost correctly', () => {
        render(
            <Provider store={store}>
                <PlanCardMobile plan={{ ...mockPlan, billingCycle: 'MONTHLY', price: '100' }} />
            </Provider>
        );
    ...
    it('calculates and displays monthly cost correctly for yearly plans', () => {
        render(
            <Provider store={store}>
                <PlanCardMobile plan={{ ...mockPlan, billingCycle: 'YEARLY', price: '1200' }} />
            </Provider>
        );
    ...
    it('shows toast message when plan is unavailable', () => {
        render(
            <Provider store={store}>
                <PlanCardMobile plan={{ ...mockPlan, is_available: false }} />
            </Provider>
        );
    ...
    it('does not render the purchase button when hideBtn is true', () => {
        render(
            <Provider store={store}>
                <PlanCardMobile plan={mockPlan} hideBtn />
            </Provider>
        );
