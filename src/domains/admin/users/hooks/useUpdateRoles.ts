...
import { getPermissionsApi, createRoles, updateRoles, createClonePartner } from '../api/index';
...
const useUpdateRoles = () => {
    ...
    return { permissionData, updateRoleApi, createNewRoles, createNewPartnerClone, isloading };
};
