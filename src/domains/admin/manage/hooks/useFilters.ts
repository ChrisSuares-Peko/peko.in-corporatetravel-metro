...
interface Props {
    ...
    setModalPartnerId?: (value: any) => void;
    initalStartDate?: string;
    initalEndDate?: string;
}

const useFilter = ({ setFilters, setModalPartnerId, initalStartDate, initalEndDate }: Props) => {
    ...
    const handleModalPartnerChange = (partnerId: string) => {
        if (partnerId && setModalPartnerId) {
