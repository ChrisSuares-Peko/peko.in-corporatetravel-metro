...
import { RolePermissionAccessData, SubscriptionPlan } from '../../types/subscriptionPlans';
...
const SubscriptionPlansPage = () => {
    ...
    const service = useFindRolesService(services?.data, 'Software Plans'); // Get the service
    useEffect(() => {
        if (service) {
