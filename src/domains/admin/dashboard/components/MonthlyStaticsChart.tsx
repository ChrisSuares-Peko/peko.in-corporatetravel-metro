...
const MonthlyStaticsChart = ({ chartData }: PropsType) => {
    ...
    const visibleData: VisibleDataState = { transactions: true, cashback: true };
    ...
    return (
        <div className="py-2 mx-2 mb-2 overflow-x-scroll h-80 bg-gray-50 md:bg-white md:py-0">
            ...
            >
                ...
                {/* Custom legend to prevent Recharts from auto-hiding items */}
                {/* <Legend
                    ...
                    payload={[
                        {
                            value: 'transactions',
                            type: 'square',
                            color: visibleData.transactions ? '#F79C9C' : '#ddd',
                        },
                        {
                            value: 'cashback',
                            type: 'square',
                            color: visibleData.cashback ? '#F79C9C' : '#ddd',
                        },
                    ]}
                /> */}

                {/* Conditionally render Bar for transactions based on visibility */}
                ...
                {/* Conditionally render Bar for cashback based on visibility */}
                {visibleData.cashback && (
