...
import CreateUpdateModal from './ServicePackageModal';
import useFilter from '../../../manage/hooks/useFilters';
import useServicePackage from '../../hooks/useServicePackage';
import { Packages, RolePermissionAccessData } from '../../types/servicePackage';
import getServicePackageColumns from '../../utils/table_column/ServicesPackageColumns';
...
const ServicePackagePage = () => {
    ...
    const service = useFindRolesService(services?.data, 'Service Packages'); // Get the service
    useEffect(() => {
        if (service) {
    ...
    const columns = getServicePackageColumns({
        handleActive,
        handleEdit,
        handleConfirmation,
        accessPermission,
