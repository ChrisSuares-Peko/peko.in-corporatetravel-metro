...
import { autoUpdate, createPackage, putUpdatePackage } from '../api/servicePackage';
import { AutoUpdateResponse, PackageWithoutID, Packages } from '../types/servicePackage';

export default function useServicePackageUpdate() {
